pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/parbatisapkota/225-lab4-1.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('sapkotp2-225-sp26')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
